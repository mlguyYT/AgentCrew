...
file_status "llm" "$STATE_DIR/llm-report.md"
file_status "research" "$STATE_DIR/research-report.md"
file_status "cnn" "$STATE_DIR/cnn-report.md"
file_status "skill_validation" "$STATE_DIR/skill-validation-report.md"

printf '%s\n' ""
printf '%s\n' "Portfolio Artifacts"
file_status "role_fit_matrix" "$STATE_DIR/role-fit-matrix.md"
file_status "mvp_scope" "$STATE_DIR/mvp-scope.md"
file_status "resume_bullets" "$STATE_DIR/resume-bullets.md"
file_status "demo_script" "$STATE_DIR/demo-script.md"
